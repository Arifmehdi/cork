                      ...
                      <div id="flStackForm" class="col-lg-12 layout-spacing layout-top-spacing">
                          <div class="statbox widget box box-shadow">
                              ...
                              <div class="widget-content widget-content-area">
                                  <form action="app/blog/blog_category/insert_add_blog_category.php" method="post" enctype="multipart/form-data">
                                    <div class="form-row mb-4">
                                      ...
                                      <button type="submit" class="btn btn-primary mt-3">Add Blog Category</button>
                                  </form>
                              </div>
                          </div>
                      </div>
