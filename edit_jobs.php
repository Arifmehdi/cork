...
$id=$_GET['id'];
$ed_q=$db->query("SELECT * FROM `jobs` Where id=$id");
                      ...
                      <div id="flStackForm" class="col-lg-12 layout-spacing layout-top-spacing">
                          <div class="statbox widget box box-shadow">
                              ...
                              <div class="widget-content widget-content-area">
                                  <form action="app/jobs/jobs/update_jobs.php" method="post" enctype="multipart/form-data">
                                      <input type="hidden" value="<?php echo $raw['id'] ?>" name="id" >
                                    <div class="form-row mb-4">
                                        <div class="form-group col-md-6">
                                            <label for="ctgname">Jobs Title</label>
                                            <input type="text" class="form-control" id="ctgname" name="jobs_title" value="<?php echo $raw['jobs_title'] ?>">
                                        </div>
                                        <div class="form-group col-md-6">
                                      ...
                                      <div class="form-group mb-4">
                                        ...
                                        <div class="form-group md-4">
                                            <label for="text">Jobs Description</label>
                                            <textarea id="editor" name="jobs_desc"><?php  echo $raw['jobs_desc']?></textarea>
                                        </div>
                                        <div class="form-group md-4">
                                            <label for="text">Jobs Main Image</label>
                                            <input class="form-control" type="file" name="jobs_main_img" value="">
                                        </div>
                                      <button type="submit" class="btn btn-primary mt-3" >Update Jobs</button>
                                  </form>
                              </div>
                          </div>
                      </div>
