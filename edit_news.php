...
$id=$_GET['id'];
$ed_q=$db->query("SELECT * FROM `news` Where id=$id");
                      ...
                      <div id="flStackForm" class="col-lg-12 layout-spacing layout-top-spacing">
                          <div class="statbox widget box box-shadow">
                              ...
                              <div class="widget-content widget-content-area">
                                  <form action="app/news/news/update_news.php" method="post" enctype="multipart/form-data">
                                      <input type="hidden" value="<?php echo $raw['id'] ?>" name="id" >
                                    <div class="form-row mb-4">
                                        <div class="form-group col-md-6">
                                            <label for="ctgname">News Title</label>
                                            <input type="text" class="form-control" id="ctgname" name="news_title" value="<?php echo $raw['news_title'] ?>">
                                        </div>
                                        <div class="form-group col-md-6">
                                      ...
                                      <div class="form-group mb-4">
                                        ...
                                        <div class="form-group md-4">
                                            ...
                                            <textarea id="editor" name="news_desc"><?php  echo $raw['news_desc']?></textarea>
                                        </div>
                                        <div class="form-group md-4">
