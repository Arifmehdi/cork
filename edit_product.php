...
$id=$_GET['id'];
$ed_q=$db->query("SELECT * FROM `product` Where id=$id");
                      ...
                      <div id="flStackForm" class="col-lg-12 layout-spacing layout-top-spacing">
                          <div class="statbox widget box box-shadow">
                              ...
                              <div class="widget-content widget-content-area">
                                  <form action="app/ecommerce/product/update_addProduct.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row mb-4">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="sellprice" name="sell_price" value="<?php echo $raw['sell_price'] ?>">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="offerprice">Offer Price</label>
                                            <input type="text" class="form-control" id="offerprice" name="offer_price" value="<?php echo $raw['offer_price'] ?>">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="offerprice">Button One name</label>
                                            <input type="text" class="form-control" id="offerprice" name="button_name" value="<?php echo $raw['button_name'] ?>">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="offerprice">Button One link</label>
                                            <input type="text" class="form-control" id="offerprice" name="button_link" value="<?php echo $raw['button_link'] ?>">
                                        </div>
                                        <div class="form-group col-md-6">
                                      ...
                                      <div class="form-group mb-4">
                                        ...
                                        <div class="form-group md-4">
                                            <label for="text">Product Desscription</label>
                                            <textarea id="editor" name="product_desc"><?php  echo $raw['prod_desc']?></textarea>
                                        </div>
                                        <div class="form-group md-4">
                                            <label for="text">Product main Image</label>
                                            <input class="form-control" type="file" name="product_main_img" value="">
                                        </div>
