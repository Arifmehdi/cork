...
$ed_q=$db->query("SELECT * FROM `product_category` Where id=$id");
                      ...
                      <div id="flStackForm" class="col-lg-12 layout-spacing layout-top-spacing">
                          <div class="statbox widget box box-shadow">
                              ...
                              <div class="widget-content widget-content-area">
                                  <form action="app/ecommerce/product_category/update_addProduct_category.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" class="form-control" id="ctgname" name="id" value="<?php echo $raw['id'] ?>">
                                      ...
                                      <button type="submit" class="btn btn-primary mt-3">Update Blog Category</button>
                                  </form>
                              </div>
                          </div>
                      </div>
