                            ...
                            <table id="default-ordering" class="table" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $result['blog_desc'] ?></td>
                                        <td><?php echo $result['blog_main_img'] ?></td>
                                        <td class="text-center"><a href="view_blog.php?id=<?php echo $result['id'] ?>" class="btn btn-primary btn-sm">View</a>&nbsp<a href="edit_blog.php?id=<?php echo $result['id'] ?>" class="btn btn-success btn-sm">Edit</a>&nbsp<a href="app/blog/blog/delete_blog.php?id=<?php echo $result['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure ?')">Delete</a></td>
                                    </tr>
                                   <?php } ?>
                                </tbody>
                                <tfoot>
