                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-6">
                            <table id="default-ordering" class="table" style="width:100%">
                                ...
                                <tbody>
                                    <?php 
                                    $show_q=$db->query("SELECT * FROM `blog_category`");
                                    $ali=0;
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><a href="view_blog_category.php?id=<?php echo $result['id'] ?>" class="btn btn-primary btn-sm">View</a>&nbsp<a href="edit_blog_category.php?id=<?php echo $result['id'] ?>" class="btn btn-success btn-sm">Edit</a>&nbsp<a href="app/blog/blog_category/delete_blog_category.php?id=<?php echo $result['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')">Delete</a></td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                                <!-- <tfoot>
