                            ...
                            <table id="default-ordering" class="table" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Jobs Main Image</th>
                                        <th class="text-center dt-no-sorting">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                     $raw=$db->query("SELECT * FROM `jobs`");
                                     $ali=0;
                                    ...
                                    <tr>
                                        <td><?php echo ++$ali; ?></td>
                                        <td><?php echo $result['jobs_title'] ?></td>
                                        ...
                                        <td><?php echo $result['jobs_desc'] ?></td>
                                        <td><?php echo $result['jobs_main_img'] ?></td>
                                        <td class="text-center"><a href="view_jobs.php?id=<?php echo $result['id'] ?>" class="btn btn-primary btn-sm">View</a>&nbsp<a href="edit_jobs.php?id=<?php echo $result['id'] ?>" class="btn btn-success btn-sm">Edit</a>&nbsp<a href="app/jobs/jobs/delete_jobs.php?id=<?php echo $result['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure ?')">Delete</a></td>
                                    </tr>
                                   <?php } ?>
                                </tbody>
                                <tfoot>
