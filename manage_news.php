                            ...
                            <table id="default-ordering" class="table" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th>news Main Image</th>
                                        <th class="text-center dt-no-sorting">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                     $raw=$db->query("SELECT * FROM `news`");
                                     $ali=0;
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $result['news_main_img'] ?></td>
                                        <td class="text-center"><a href="view_news.php?id=<?php echo $result['id'] ?>" class="btn btn-primary btn-sm">View</a>&nbsp<a href="edit_news.php?id=<?php echo $result['id'] ?>" class="btn btn-success btn-sm">Edit</a>&nbsp<a href="app/news/news/delete_news.php?id=<?php echo $result['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure ?')">Delete</a></td>
                                    </tr>
                                   <?php } ?>
                                </tbody>
                                <tfoot>
