                              ...
                              <div class="widget-content widget-content-area">
                                  <table class="table" style="color:white">
                                          ...
                                          <tr>
                                            ...
                                            <tr>
                                                <td style="color:white">Blog Description</td>
                                                <td><?php echo $raw['blog_desc'] ?></td>
                                          </tr>

                                            <tr>
                                                <td style="color:white">Blog Main Image</td>
                                                <td><?php echo $raw['blog_main_img'] ?></td>
                                          </tr>
