                          ...
                          <div class="statbox widget box box-shadow">
                              ...
                              <div class="widget-content widget-content-area">
                                  <table class="table" style="color:white">
                                          ...
                                          <tr>
                                                <td style="color:white">jobs Title</td>
                                                <td><?php echo $raw['jobs_title'] ?></td>
                                          </tr>
                                          ...
                                          <tr>
                                            ...
                                            <tr>
                                                <td style="color:white">jobs Description</td>
                                                <td><?php echo $raw['jobs_desc'] ?></td>
                                          </tr>

                                            <tr>
                                                <td style="color:white">jobs Main Image</td>
                                                <td><?php echo $raw['jobs_main_img'] ?></td>
                                          </tr>
