...
$ed_q=$db->query("SELECT * FROM `jobs_role` Where id=$id");
                          ...
                          <div class="statbox widget box box-shadow">
                              ...
                              <div class="widget-content widget-content-area">
                                  <table class="table" style="color:white">
                                          ...
                                          <tr>
                                                <td style="color:white">Role Name</td>
                                                <td><?php echo $raw['role_name'] ?></td>
                                          </tr>

                                          <tr>
                                                <td style="color:white">Role Description</td>
                                                <td><?php echo $raw['role_desc'] ?></td>
                                          </tr>

                                          <tr>
                                                <td style="color:white">Role Icon</td>
                                                <td><?php echo $raw['role_icon'] ?></td>
                                          </tr>
                                          ...
                                          <tr>
                                            ...
                                            <tr>
                                                <td style="color:white">Team</td>
                                                <td><?php echo $raw['role_team'] ?></td>
                                            </tr>
