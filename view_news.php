                          ...
                          <div class="statbox widget box box-shadow">
                              ...
                              <div class="widget-content widget-content-area">
                                  <table class="table" style="color:white">
                                          ...
                                          <tr>
                                                <td style="color:white">News Title</td>
                                                <td><?php echo $raw['news_title'] ?></td>
                                          </tr>
                                          ...
                                          <tr>
                                            ...
                                            <tr>
                                                <td style="color:white">News Description</td>
                                                <td><?php echo $raw['news_desc'] ?></td>
                                          </tr>

                                            <tr>
                                                <td style="color:white">News Main Image</td>
                                                <td><?php echo $raw['news_main_img'] ?></td>
                                          </tr>
