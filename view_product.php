                          ...
                          <div class="statbox widget box box-shadow">
                              ...
                              <div class="widget-content widget-content-area">
                                  <table class="table" style="color:white">
                                          ...
                                          <tr>
                                                <td style="color:white">Sale Price</td>
                                                <td><?php echo $raw['sell_price'] ?></td>
                                          </tr>

                                          <tr>
                                                <td style="color:white">Offer Price</td>
                                                <td><?php echo $raw['offer_price'] ?></td>
                                          </tr>

                                          <tr>
                                                <td style="color:white">Button Name</td>
                                                <td><?php echo $raw['button_name'] ?></td>
                                          </tr>

                                          <tr>
                                                <td style="color:white">Button Link</td>
                                                <td><?php echo $raw['button_link'] ?></td>
                                          </tr>
                                          ...
                                          <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $raw['prod_img'] ?></td>
                                          </tr>

                                          <tr>
                                                <td style="color:white">Product Description</td>
                                                <td><?php echo $raw['prod_desc'] ?></td>
                                          </tr>
